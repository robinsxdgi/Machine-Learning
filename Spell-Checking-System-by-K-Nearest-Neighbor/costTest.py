# EECS 349 Machine Learning, Spell Checking System, P3.1
# Ding Xiang
# October,1,2017
#########################
...
def main():
    ...
    for deletion_cost in [0, 1, 2, 4]:
        for insertion_cost in [0, 1, 2, 4]:
            for substitution_cost in [0, 1, 2, 4]:
                # Start time
                start = time.time()
                ...
                print 'In cost combination', deletion_cost, insertion_cost, substitution_cost, 'The total time is:', time.time() - start
