...
# python '/Users/Rockwell/PycharmProjects/MLHW4/item_cf.py' '/Users/Rockwell/PycharmProjects/MLHW4/ml-100k/u.data' 4 55 0 3 1
...
def item_based_cf(datafile, userid, movieid, distance, k, iFlag, numOfUsers, numOfItems):
    ...
    # first calculate each distance between each movie to the target movie
    # make all the distance to a list, which has numOfItems elements
    ...
    if distance == 0:
        # The larger Pearson's coefficient is, the similar two movies will be
    ...
    if iFlag == 0:
        while (k_real < k) and (k_temp < numOfItems):
            ...
            # first of all, remove the movie itself
